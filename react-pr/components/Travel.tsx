...
const TravelSite = ({ backgroundImage, title, subtitle, peopleJoined }:
    TravelProps) => {
    return (
            ...
            <div className="flexEnd mt-10 px-6 lg:-mt-60 lg:mr-6">
                <div className="bg-green-50 p-8 lg:max-w-[500px] xl:max-w-[734px] xl:rounded-5xl xl:px-16 xl:py-20 relative w-full overflow-hidden rounded-3xl">
                    ...
                    <p className="regular-14 xl:regular-16 mt-5 text-white">
                        Starting from the anxiety of the visiters when visiting a new  location, the possibility of getting lost is very large. That's why we are here for those of you who want to start an adventure
                    </p>
                </div>
            </div>
        </section>
